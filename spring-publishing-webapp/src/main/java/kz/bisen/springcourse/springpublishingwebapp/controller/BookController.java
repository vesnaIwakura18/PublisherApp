...
public class BookController {
    ...
    @GetMapping
    public List<BookDto> getAllPaginated(@RequestParam(value = "page") Integer page,
    ...
    @PutMapping("/{id}")
    public BookDto update(@PathVariable("id") Integer id,
                            @RequestBody @Valid BookDto updatedBookDto,
